...
<div class="wrapper">
  ...
  <a href="#" class="brand-link">
    ...
    <span class="brand-text font-weight-light"><b>HALAMAN ADMIN</b></span>
  </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('peserta/') }}" class="nav-link active">
  ...
  <footer class="main-footer">
    ...
    SPK Penentuan Kelayakan SMA Adiwiyata di Kota Tegal
